...
const item: Item = {
	...
	date: [new Date("2023-01-12"), new Date("2024-11-02")],
		...
		items: [
			{
				service: "github",
				badge: "lastCommit",
				link: "https://github.com/kimzuni/blog/tree/jekyll",
			},
			{
				service: "badge",
	...
	sections: [
		{
			...
			descriptions: [
				"Jekyll을 활용하여 테마부터 필요한 플러그인까지 직접 제작했으며, 사이트는 GitHub Pages를 통해 배포됩니다.",
		...
		},
		{
			...
			descriptions: [
				...
				"상단에는 백엔드 상태를 실시간으로 표시하여 서비스 이용 가능 여부를 즉시 확인할 수 있습니다.",
			],
		},
	],
};

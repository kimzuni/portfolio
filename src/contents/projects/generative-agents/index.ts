...
const externalAddress = "/videos/generative-agents-external-address.webm";
		...
		contributions: [
			{
				label: "Backend (Web)",
				percentage: 100,
				description: "Django 기반 사용자 권한 관리 시스템 구축 및 시뮬레이션 데이터 조회용 API 구현",
			},
			{
				label: "DevOps/Infra",
				percentage: 100,
				description: "Docker 기반 서비스 컨테이너화 및 Ollama 연동형 멀티 컨테이너 환경 구축",
			},
			{
				label: "Frontend",
				percentage: 100,
				description: "전반적인 UI/UX 설계 및 구현 / Phaser 구조 리펙토링 및 커스텀 맵 제작",
			},
			{
				label: "AI Engineering",
				percentage: 0,
				description: "자율형 에이전트 구현을 위한 멀티 스텝 프롬프트 설계 및 공격/방어 시나리오 생성",
			},
			{
				label: "Backend (AI)",
				percentage: 0,
				description: "의사결정 로직과 시뮬레이션 환경 간의 인터페이스 구축 및 행동 자동화 스크립트 구현",
			},
		],
	},
	badges: [

	...
	sections: [
		{
			...
			descriptions: [
				"Generative Agents 기반의 AI 에이전트를 활용해 블랙/화이트 해커 시뮬레이션을 구현했습니다. AI 에이전트는 지정한 웹 서버에 대한 해킹 공격과 방어 시나리오를 자동으로 생성 및 수행하고, 탐지된 취약점에 대해 자동으로 패치 방법을 제안합니다. 보안을 위해 외부 서버를 공격 대상으로 지정할 수 없도록 제한하여 오용을 방지했습니다.",
		...
		},
		{
			...
			descriptions: [
				"원본 프로젝트는 실시간 모니터링과 재생 기능만 제공했으나, 프로젝트 코드를 분석하고 리팩토링하여 다양한 기능을 추가하고 컨트롤러와 대시보드 연동까지 구현함으로써 완전한 시뮬레이션 환경을 구축했습니다.",
				"프로젝트 전용 도커 이미지 제작하여 보다 안전하고 편리하게 사용할 수 있으며, 내장된 전용 명령어로 프론트엔드, 백엔드, API 등 주요 서비스를 손쉽게 실행할 수 있습니다. 또한 GitHub Actions를 활용해 도커 이미지 빌드 및 배포를 자동화했습니다.",
			],
		},
		{
			media: [
